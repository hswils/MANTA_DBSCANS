...
#pfusi_int = rootgrp['pfusi'][-1]
    ...
    var_dic = {'ne':ne,'ni':ni,'te':te,'ti':ti,'ipol':ipol,'jbs':jbs,'jrf':jrf}
    lw = 2
    c1 = 'green'
    c2 = 'lime'
    c3 = 'magenta'
    ...
    ax5.set_ylabel('q')
'''
    ax1.plot(rho,var_dic[argv[1]], linewidth = lw)
    #ax1.set_ylabel()
#ax1.text(0.5,0.8,'{:.1f} MA'.format(ip),color = c3,transform = ax1.transAxes)
'''

...
'''
ax3.plot(rho_main,Te_main,color = c1,linewidth = lw)
ax3.plot(rho_ips,Te_ips,color = c2,linewidth = lw,linestyle = 'dashed')
ax4.plot(rho_main,Ti_main,color = c1,linewidth = lw)
ax4.plot(rho_ips,Ti_ips,color = c2,linewidth = lw,linestyle = 'dashed')
ax3.set_ylabel('e temp [keV]')
ax4.set_ylabel('i temp [keV]')

ax5.plot(rho_main,rot_main,color = c1,linewidth = lw)
ax5.plot(rho_ips,rot_ips,color = c2,linewidth = lw,linestyle = 'dashed')
ax5.set_ylabel('rot [krad/s]')
